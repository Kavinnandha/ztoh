            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="text-center max-w-3xl mx-auto mb-20">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-block mb-4 px-4 py-1.5 rounded-full bg-white border border-slate-200 shadow-sm text-sm font-semibold text-secondary"
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        transition={{ delay: 0.2 }}
                        className="bg-white p-8 rounded-[2rem] shadow-xl shadow-slate-200/50 border border-slate-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 h-full"
                    >
                    ...
                    <motion.div
                        ...
                        className="bg-slate-900 p-8 rounded-[2rem] text-white shadow-2xl shadow-primary/30 relative overflow-hidden transform lg:-translate-y-6 lg:scale-105 z-10"
                    >
